...
func (r ApiGetWantedMissingRequest) IncludeSeries(includeSeries bool) ApiGetWantedMissingRequest {
	r.includeSeries = &includeSeries
	return r
}

func (r ApiGetWantedMissingRequest) IncludeImages(includeImages bool) ApiGetWantedMissingRequest {
	r.includeImages = &includeImages
	return r
}

func (r ApiGetWantedMissingRequest) Execute() (*EpisodeResourcePagingResource, *http.Response, error) {
...
func (a *MissingApiService) GetWantedMissingExecute(r ApiGetWantedMissingRequest) (*EpisodeResourcePagingResource, *http.Response, error) {
	var (
...
func (r ApiGetWantedMissingByIdRequest) Execute() (*EpisodeResource, *http.Response, error) {
...
func (a *MissingApiService) GetWantedMissingByIdExecute(r ApiGetWantedMissingByIdRequest) (*EpisodeResource, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
