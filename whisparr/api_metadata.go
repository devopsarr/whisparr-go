...
type ApiDeleteMetadataBulkRequest struct {
	ctx context.Context
	ApiService *MetadataApiService
	metadataBulkResource *MetadataBulkResource
}

func (r ApiDeleteMetadataBulkRequest) MetadataBulkResource(metadataBulkResource MetadataBulkResource) ApiDeleteMetadataBulkRequest {
	r.metadataBulkResource = &metadataBulkResource
	return r
}

func (r ApiDeleteMetadataBulkRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteMetadataBulkExecute(r)
}

/*
DeleteMetadataBulk Method for DeleteMetadataBulk

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiDeleteMetadataBulkRequest
*/
func (a *MetadataApiService) DeleteMetadataBulk(ctx context.Context) ApiDeleteMetadataBulkRequest {
	return ApiDeleteMetadataBulkRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *MetadataApiService) DeleteMetadataBulkExecute(r ApiDeleteMetadataBulkRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetadataApiService.DeleteMetadataBulk")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/metadata/bulk"
	...
	// body params
	localVarPostBody = r.metadataBulkResource
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apikey"]; ok {
...
type ApiPutMetadataBulkRequest struct {
	ctx context.Context
	ApiService *MetadataApiService
	metadataBulkResource *MetadataBulkResource
}

func (r ApiPutMetadataBulkRequest) MetadataBulkResource(metadataBulkResource MetadataBulkResource) ApiPutMetadataBulkRequest {
	r.metadataBulkResource = &metadataBulkResource
	return r
}

func (r ApiPutMetadataBulkRequest) Execute() (*MetadataResource, *http.Response, error) {
	return r.ApiService.PutMetadataBulkExecute(r)
}

/*
PutMetadataBulk Method for PutMetadataBulk

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPutMetadataBulkRequest
*/
func (a *MetadataApiService) PutMetadataBulk(ctx context.Context) ApiPutMetadataBulkRequest {
	return ApiPutMetadataBulkRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MetadataResource
func (a *MetadataApiService) PutMetadataBulkExecute(r ApiPutMetadataBulkRequest) (*MetadataResource, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetadataApiService.PutMetadataBulk")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
