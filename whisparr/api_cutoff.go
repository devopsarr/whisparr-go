...
func (r ApiGetWantedCutoffRequest) IncludeEpisodeFile(includeEpisodeFile bool) ApiGetWantedCutoffRequest {
...
func (r ApiGetWantedCutoffRequest) Execute() (*EpisodeResourcePagingResource, *http.Response, error) {
...
func (r ApiGetWantedCutoffByIdRequest) Execute() (*EpisodeResource, *http.Response, error) {
