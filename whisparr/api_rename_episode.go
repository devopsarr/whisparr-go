...
func (r ApiListRenameRequest) SeriesId(seriesId int32) ApiListRenameRequest {
	r.seriesId = &seriesId
	return r
}

func (r ApiListRenameRequest) SeasonNumber(seasonNumber int32) ApiListRenameRequest {
